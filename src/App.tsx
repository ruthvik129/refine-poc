...
import { useNotificationProvider, ThemedLayoutV2, ErrorComponent, AuthPage, RefineThemes, ThemedTitleV2 } from '@refinedev/antd'
import { GoogleOutlined, GithubOutlined, DashboardOutlined } from '@ant-design/icons'
							...
							>
								<Route
									...
									element={
										<AuthPage
											title={
												<ThemedTitleV2 text="My Project" collapsed={false}/>
											}
											type='login'
											formProps={{
												initialValues: {
